...
"#if DEBUGEXEC",
"	fprintf(stderr, \"set process gid to current gid %d\\n\",getgid());",
"#endif",
"        setgid(getgid());",
"#elif CHECK_EFFECTIVE(GID)",
"#if DEBUGEXEC",
"	fprintf(stderr, \"set process gid to current egid %d\\n\",getegid());",
"#endif",
"        setgid(getegid());",
"#elif defined GID",
"#if DEBUGEXEC",
"	fprintf(stderr, \"set process gid to value %d\\n\",GID);",
"#endif",
"        setgid(GID);",
"#endif",
"#if CHECK_REGULAR(UID)",
"#if DEBUGEXEC",
"	fprintf(stderr, \"set process uid to current uid %d\\n\",getuid());",
"#endif",
"        setuid(getuid());",
"#elif CHECK_EFFECTIVE(UID)",
"#if DEBUGEXEC",
"	fprintf(stderr, \"set process uid to current euid %d\\n\",geteuid());",
"#endif",
"        setuid(geteuid());",
"#elif defined UID",
"#if DEBUGEXEC",
"	fprintf(stderr, \"set process uid to value %d\\n\",UID);",
"#endif",
"        setuid(UID);",
"#elif SETUID",
"#if DEBUGEXEC",
"	fprintf(stderr, \"set process uid to 0\\n\");",
"#endif",
"        setuid(0);",
"#endif",
"#if DEBUGEXEC",
